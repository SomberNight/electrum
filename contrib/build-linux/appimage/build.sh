...
verify_hash "$CACHEDIR/Python-$PYTHON_VERSION.tar.xz" "991c3f8ac97992f3d308fefeb03a64db462574eadbff34ce8bc5bb583d9903ff"
...
(
    ...
    # Patch taken from Ubuntu http://archive.ubuntu.com/ubuntu/pool/main/p/python3.9/python3.9_3.9.1-2.debian.tar.xz
