...
verify_hash "$CACHEDIR/Python-3.6.8.tar.xz" "35446241e995773b1bed7d196f4b624dadcadc8429f26282e756b2fb8a351193"
...
info "preparing electrum-icons and electrum-locale."
(
    cd "$PROJECT_ROOT"
    ...
    cp "$CONTRIB"/deterministic-build/electrum-icons/icons_rc.py "$PROJECT_ROOT"/electrum/gui/qt/
)
