...
class LNWatcher(PrintError):
    ...
    def on_network_update(self, event, *args):
        if not self.synchronizer.synchronizer.is_up_to_date():
            return
        #print("lnwatcher.on_network_update")
        with self.lock:
    ...
    def check_onchain_situation(self, funding_outpoint):
        #print("check_onchain_situation entered", funding_outpoint)
        ...
        #print("check_onchain_situation cp1", funding_outpoint, is_funding_txo_spent)
        ...
        if conf == 0:
            return
        #print("check_onchain_situation cp2 verified", funding_outpoint)
        keep_watching_this = self.inspect_ctx_candidate(funding_outpoint, ctx_candidate)
        #print("check_onchain_situation cp3 keep_watching_this", funding_outpoint, keep_watching_this)
